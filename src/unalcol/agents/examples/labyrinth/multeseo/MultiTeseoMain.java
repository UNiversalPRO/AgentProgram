...
import unalcol.agents.examples.labyrinth.multeseo.universal.MultiUniversalAgent;
import unalcol.agents.examples.labyrinth.multeseo.universalViejo.MarcandoMultiUniversalAgent;
...
public class MultiTeseoMain {
  ...
  public static void main( String[] argv ){
     ...
     teseo[0] = new MultiUniversalAgent();
     ((MultiUniversalAgent) teseo[0]).setLanguage( getLanguage() );
     teseo[1] = new MarcandoMultiUniversalAgent();
     (( MarcandoMultiUniversalAgent ) teseo[1]).setLanguage( getLanguage() );
